...
public class RepairSchedule
{
    ...
    {
        ArrayList<Integer> availiableMechanics = new ArrayList<Integer>();
        for (int i = 0; i < numberOfMechanics; i++)
        {
            availiableMechanics.add(i);
        }
        for (int j = 0; j < schedule.size(); j++)
        {
            availiableMechanics.remove(schedule.get(j).getMechanicNum());
        }
        return availiableMechanics;
    }
